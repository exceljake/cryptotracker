...
class WalletsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wallet" do
    assert_difference("Wallet.count") do
      post wallets_url, params: { wallet: { overall_worth: @wallet.overall_worth, wallet_type: @wallet.wallet_type } }, as: :json
    end
  ...
  test "should update wallet" do
    patch wallet_url(@wallet), params: { wallet: { overall_worth: @wallet.overall_worth, wallet_type: @wallet.wallet_type } }, as: :json
    assert_response :success
  end
